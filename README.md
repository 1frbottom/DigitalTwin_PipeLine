...
* **개발 목표**
    이기종 데이터(CCTV, 교통, 유동인구 등)의 실시간 수집 및 동기화 기술 개발

* **핵심 성과**
    데이터 발생부터 적재까지 평균 레이턴시 **1.2초~1.8초** 달성 및 확장성 보장

* **기여**
    디지털 트윈의 핵심인 '실시간성(Real-time)' 확보 및 동기화 상태를 판단하는 '실시간율(Freshness)' 로직 도입
