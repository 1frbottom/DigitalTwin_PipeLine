...
### 배경
- 현재 디지털 트윈 기술은 시각적 가시화(Unity, Unreal)에 집중되어 있어, 현실 데이터와의 동기화가 미비하거나 실시간성이 부족한 문제가 있습니다.<br><br>
...
전체 시스템은 **Docker Container** 환경에서 MSA(Microservice Architecture)와 유사한 구조로 동작합니다.<br><br>
